...
namespace SpriteLibrary
{
    public class Sprite
    {
        ...
        private void randomiseTrajectory(Vector2 startPoint, Vector2 endPoint, Vector2 midPoint, int maxDivergence, int minDivergence, int originalDirection, int minSpeed, int maxSpeed, int minLifeSpan, int maxLifeSpan) 
        {
        // startPoint and endPoint are the area sprites appear from, max and minDivergence is the amount in degrees sprites are allowed to diverge from the originalDirection. min and maxSpeed are
        // self explanatory, the lower the value, the shorter distance the sprite will make before dying. min and maxLifeSpan work the same.
